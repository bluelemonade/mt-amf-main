      ...
      <div class="grid-container">
        ...
        <div class="grid-text">
           <h1>
            ...
            {{ content["fundorte-"+ getLanguage][parseInt($route.params.id)-1].fundort }}
          </h1>
          <p>
            {{ content["fundortlabel-" + getLanguage] [1] }} <br>
            {{ content["fundorte-"+ getLanguage][parseInt($route.params.id)-1].lage }}
          </p>
          <p>
            {{ content["fundortlabel-" + getLanguage] [2] }} <br>
            {{ content["fundorte-"+ getLanguage][parseInt($route.params.id)-1].alter }}
          </p>
          <p>
            {{ content["fundortlabel-" + getLanguage] [3] }} <br>
            {{ content["fundorte-"+ getLanguage][parseInt($route.params.id)-1].homininen }}
          </p>
          <p> 
            {{ content["fundortlabel-" + getLanguage] [4] }} <br>
            {{ content["fundorte-"+ getLanguage][parseInt($route.params.id)-1].funde }}
          </p>
          <p> 
            {{ content["fundortlabel-" + getLanguage] [5] }} <br>
            {{ content["fundorte-"+ getLanguage][parseInt($route.params.id)-1].forschungsgeschichte }}
          </p>
