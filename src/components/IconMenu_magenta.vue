...
methods: {
    initFrame() {
        ...
        for (var i = 0; i < this.circleShapes.length; i++) {
            // gsap.to(this.circleShapes[i], {x: 1920, y: 1080, delay: 0, ease:"elastic"});
        ...
        // gsap.set(".circlepulse", {transformOrigin:"center center"});
        ...
        for (i = 0; i < blob.length; i++) {
            gsap.to(blob[i], this.random(20, 30), {scale: this.random(1.2, 1.7), yoyoEase:true, yoyo: true, repeat:-1, repeatDelay:1}); 
            gsap.to(blob[i], this.random(30, 50), {rotation: 360, repeat:-1, repeatDelay:0, yoyoEase:true, yoyo: true}); 
        }
    ...
    firstMovement(element, i) {
        ...
        // );
        // tl.restart();
        gsap.to(element, this.random(1, 2.8), {x: this.random( 1920 - 1400 , + 1920+  1400), y: this.random(1080 - 700, 1080 + 700), delay: 1, ease:"elastic", onComplete:this.randomMovement, onCompleteParams:[element, i]});
    },
    randomMovement(element, arrayPos) { 
        ...
        while (isInside == true) {
            ...
            var newPoint = [ this.random(1920 - 1400 , 1920 + 1400), this.random(1080 - 700, 1080 + 700) ];
