...
<template>
  ...
  <svg version="1.1" class="svg-container" :ref="'stammbaum-leben-spiel-svg' + idNr" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <image xlink:href="../assets/stammbaum-leben-icon/qualle.svg" x="50" y="500" height="100px" width="100px"  class="icon e0"></image>
    <image xlink:href="../assets/stammbaum-leben-icon/fisch.svg" x="150" y="500" height="100px" width="100px"  class="icon e1"></image>
    <image xlink:href="../assets/stammbaum-leben-icon/giraffe.svg" x="250" y="500" height="100px" width="100px" class="icon e2"></image>
    <image xlink:href="../assets/stammbaum-leben-icon/primat.svg" x="350" y="500" height="100px" width="100px" class="icon e3"></image>
    <image xlink:href="../assets/stammbaum-leben-icon/gorilla.svg" x="450" y="500" height="100px" width="100px" class="icon e4"></image>
    <image xlink:href="../assets/stammbaum-leben-icon/human.svg" x="550" y="500" height="100px" width="100px" class="icon e5"></image>
